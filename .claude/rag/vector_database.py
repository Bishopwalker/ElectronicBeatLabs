...
class ChromaVectorDatabase(BaseVectorDatabase):
    ...
    def __init__(self, persist_directory: str = "./.claude/rag/chroma_db", **kwargs):
    ...
    def _prepare_metadata(self, chunk: CodeChunk) -> Dict:
        # Convert list values to comma-separated strings and filter out None values
        ...
        for key, value in chunk.metadata.items():
            if value is None:
                ...
                prepared_metadata[key] = ', '.join(str(v) for v in value)
            else:
...
class SupabaseVectorDatabase(BaseVectorDatabase):
    ...
    def __init__(
        ...
        supabase_url: str,
        supabase_key: str,
        table_name: str = "ebl_code_chunks",
        **kwargs
    ):
        """
