"""
EBL Memory Service - Persistent Session & Context Memory with Mem0
...
class MemoryService:
    ...
    def save_session_memory(
        ...
        Args:
            ...
            content: Memory content (e.g., "Working on audio engine optimization")
        ...
        Example:
            ...
            ...     content="Fixed audio buffer starvation in useHybridAudioEngine.ts",
            ...     metadata={"files": ["src/hooks/useHybridAudioEngine.ts"], "feature": "audio"}
            ... )
        """
    ...
    def save_code_context(
        ...
        Example:
            ...
            ...     context="Increased buffer size from 16 to 32 frames to prevent underruns"
            ... )
        """
        metadata = {
    ...
    def get_code_context(self, file_path: str, limit: int = 5) -> List[Dict[str, Any]]:
        ...
        Example:
            >>> contexts = service.get_code_context("src/hooks/useHybridAudioEngine.ts")
            >>> for ctx in contexts:
    ...
    def save_decision(
        ...
        Example:
            ...
            ...     rationale="Better performance, non-blocking audio processing",
            ...     outcome="Successfully eliminated audio glitches"
            ... )
        """
    ...
    def search_decisions(self, query: str, limit: int = 5) -> List[Dict[str, Any]]:
        ...
        Args:
            query: Search query (e.g., "audio architecture")
            limit: Maximum results
    ...
    def save_learning(
        ...
        Args:
            ...
            category: Category (e.g., "audio", "performance", "bug_fix")
        ...
        Example:
            ...
            ...     lesson="Increasing buffer size to 32 frames prevents audio glitches",
    ...
    def get_learnings(
        ...
        Example:
            >>> successes = service.get_learnings(category="audio", outcome="success")
    ...
    def enhance_rag_query(
        ...
        Example:
            >>> # User working on audio engine
            >>> enhanced = service.enhance_rag_query(
            ...     query="buffer management",
            ...     session_id="session_123"
            ... )
            >>> # Result: "buffer management (context: working on audio engine, recent files: useHybridAudioEngine.ts)"
        """
        if not session_id:
            return query
...
if __name__ == "__main__":
    ...
    memory.save_session_memory(
        ...
        content="Working on audio engine buffer optimization",
        metadata={"feature": "audio", "priority": "high"}
    )
    ...
    print(f"Found {len(results)} memories about audio buffer")

    # Example: Enhance RAG query
    enhanced = memory.enhance_rag_query("buffer management", session_id)
