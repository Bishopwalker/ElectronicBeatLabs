...
class RAGConfig:
    ...
    Environment Variables:
        ...
        SUPABASE_TABLE: Table name for vector storage (default: "ebl_code_chunks")
...
def load_config() -> RAGConfig:
    ...
    supabase_table = os.getenv("SUPABASE_TABLE", "ebl_code_chunks")
...
def print_config_summary(config: RAGConfig):
    ...
    """
    print("=" * 60)
    print("EBL RAG System Configuration")
    print("=" * 60)
