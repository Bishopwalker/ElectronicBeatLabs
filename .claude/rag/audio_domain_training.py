...
class AudioDomainTrainingGenerator:
    ...
    def __init__(self, chunks_file: str = ".claude/rag/data/ebl_chunks.json"):
    ...
    def generate_training_dataset(self, output_file: str = ".claude/rag/data/audio_training_data.jsonl"):
...
class EmbeddingFineTuner:
    ...
    def fine_tune(self,
                  training_file: str,
                  output_model_path: str = ".claude/rag/models/ebl-audio-embeddings",
                  epochs: int = 4,
                  batch_size: int = 16):
        """
